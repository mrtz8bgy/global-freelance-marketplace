...
-- Records of profiles
-- ----------------------------
INSERT INTO `profiles` VALUES (1, 3, 'demo-employer', 'کارفرمای نمونه', 'مدیریت پروژه و استخدام متخصص', 'ما به دنبال همکاری با متخصصان خلاق و حرفه‌ای هستیم.', NULL, NULL, NULL, 'Asia/Tehran', NULL, 'available', NULL, 0, 0, NULL, 100, 0.00, 0, '2026-08-24 23:45:50', '2026-08-24 23:45:50');
